...
When running under ADFS in an upgraded environment, the workflow editor may have trouble starting. If it does, please ensure that the url https://dynamicsaxworkfloweditor/ is added to the property "Microsoft Dynamics 365 for Operations On-premises - Workflow - Native application" in the AD FS settings.
